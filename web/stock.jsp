                                    ...
                                    <div class="pagination">
                                        <ul class="pagination">
                                            <c:forEach begin="${1}" end="${requestScope.num}" var="i">
                                                 <li class="page-item ${i==page?"active":""}"><a class="page-link" href="stock?page=${i}">${i}</a></li>
                                            </c:forEach>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <span style=""><a href="<%=request.getContextPath()%>/stockexport?id=5" ><button class="customBtn col-2 btn btn-primary stick"><i class="fa fa-file-excel-o"></i> Export to Excel</button></a></span>
                        </div>   
