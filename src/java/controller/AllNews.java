...
public class AllNews extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AllNews</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AllNews at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<Product> productListMax = pd.getMaxQuan();
        request.setAttribute("productListMax", productListMax);
        
        NewsDAO nd = new NewsDAO();
        List<News> listnew = nd.getNewbyNavigationID(5);
