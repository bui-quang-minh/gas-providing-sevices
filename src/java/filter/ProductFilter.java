 ...
 * @author Minh Bui
 */
@WebFilter(filterName="ProductFilter", urlPatterns={"/addproduct"})
public class ProductFilter implements Filter {
	...
	if (debug) log("ProductFilter:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("ProductFilter:DoAfterProcessing");
	...
	*/
	...
	if (debug) log("ProductFilter:doFilter()");
	...
	if (filterConfig == null) return ("ProductFilter()");
