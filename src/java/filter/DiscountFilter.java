 ...
 * @author Minh Bui
 */
@WebFilter(filterName="DiscountFilter", urlPatterns={"/alldiscount"})
public class DiscountFilter implements Filter {
	...
	if (debug) log("DiscountFilter:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("DiscountFilter:DoAfterProcessing");
	...
	*/
	...
	if (debug) log("DiscountFilter:doFilter()");
	...
	if (filterConfig == null) return ("DiscountFilter()");
